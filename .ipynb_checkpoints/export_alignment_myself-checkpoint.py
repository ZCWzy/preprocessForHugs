...
def read_4d_humans(images_dir,raw_smpl):
    ...
    for item in hmr_result.items():
        ...
        # print(body_pose[0].reshape(69))
        # print("——————————————————————————————————————————————————————————————")
        # vibe_estimates['pose'].append(body_pose[0].reshape(69))
...
def make_smpl_opt(path, scales, transl, rotations):
    ...
    for item, rot in zip(hmr_result.items(), rotations):
        ...
        #     print(pose)
        #     print("@@")
        #     tmp = rotation.rotation_matrix_to_angle_axis(pose.clone().detach())
        #     # print(tmp.reshape(69))
        #     tmpbdps.append(tmp)
        # # print(tmpbdps)
        # print("——————————————————————————————————————————————————————————————")
        # body_pose.append(tmpbdps)
        tmpbdps = rotation.rotation_matrix_to_angle_axis(pic['smpl'][0]['body_pose'].clone().detach())
        tmpbdps = tmpbdps.reshape(69)
        body_pose.append(tmpbdps)
        # 处理bbox
        tmpbbox = pic['bbox'][0]
        ...
        global_orient.append(np.array(tmpgo).reshape(3))
